...
public class MaintainDistance extends Command {
  ...
  public MaintainDistance(PhotonVision photonVision, TankDrive driveSubsystem) {
    this.photonVision = photonVision;
    this.tankSubsystem = driveSubsystem;
  ...
  public void execute() {
    ...
    rotSpeed = 0;
    tankSubsystem.drive(forwardSpeed, rotSpeed);
  }
